...
class Node:
    ...
    Attributes:
         data - stored data
         next - it is the link to the next node
    """

    def __init__(self, data=None, next=None):
        """
        Initialises the Node with the attributes given
        """
        self.data = data
        self.next = next
...
class LinkedList:
    ...
    Methods:
         insert_at_end - it is used to insert node with data at the end of the list
         status - displays all elements of the list
    Attributes
         self.head - contains first node of LinkedList, None if list is empty
    """
